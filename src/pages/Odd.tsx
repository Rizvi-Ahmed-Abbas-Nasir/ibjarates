...
const BoostCardApproval = () => {
  return (
    <section className="py-[7rem] bg-[#74737311]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 px-5 lg:px-[7rem]">
        {features.map((feature, index) => (
          <div
            key={index}
            className="bg-white rounded-[2rem] h-[24rem] flex flex-col justify-between p-[6rem] text-center shadow-md hover:shadow-lg transition duration-300"
          >
