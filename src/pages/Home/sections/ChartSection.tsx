...
export default function ChartSection() {
  ...
  const [chartData, setChartData] = useState<number[]>([1200, 1900, 3000, 2500, 2800, 3500, 4100]);
  ...
  const handleFetchData: (rangeType: string) => Promise<void> = async (rangeType: string): Promise<void> => {
    try {
    ...
    if (rangeType === "weekly") {
      ...
      setChartData([1200, 1900, 3000, 2500, 2800, 3500, 4100, 4300, 2000, 3000, 3900, 4500]); // 12 data points for monthly
